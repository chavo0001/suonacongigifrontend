// Riassunto: Componente dettaglio thread che mostra post e permette rispondere/moderare.
...
export class ThreadDetailComponent extends BaseComponent implements OnInit {
  ...
  // Iniettare il CensuraService per mostrare/nascondere il badge "filtro attivo"
  readonly censura = inject(CensuraService);
